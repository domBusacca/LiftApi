...
namespace LiftApi.App_Start
{
    ...
    public class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IFlightRepo, FlightRepo>();
            container.RegisterType<IMeetManager, MeetManager>();
            container.RegisterType<IMeetRepo, MeetRepo>();
            container.RegisterType<ILifterManager, LifterManager>();
            container.RegisterType<ILifterRepo, LifterRepo>();
            container.RegisterType<ILiveMeetBuilder, LiveMeetBuilder>();
        }
    }
}
